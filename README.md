...
Фронтенд-разработчик с 1+ годами опыта. Пишу на JavaScript, TypeScript, React. Разрабатывал landing page, SPA приложения на JS и React. Интересуюсь информационными технологиями, фронтенд разработкой  и тем, как они помогают бизнесу. Имею огромное желание расти и развиваться.
